# Spatial Vulnerability and Climate-Induced Migration
**Author:** A. Z. M. Khalid
...
The logistic regression demonstrates a highly statistically significant inverse relationship between social network size and migration intent (p < 0.01). This model quantitatively supports the structuralist perspective that the degradation of support systems under environmental pressure serves as a primary catalyst for human displacement.
